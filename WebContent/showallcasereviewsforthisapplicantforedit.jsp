			...
			<%
				...
				while(caseReviewItr.hasNext()){
					...
					<tr>
						...
						<td>
							<a href="#.jsp" onclick="showEditFieldsOfThisCaseReview(<%=caseReview.getId() %>);">Edit</a>
						</td>
					</tr>
					<%
						String divId = "caseReviewEditDiv"+caseReview.getId();
					%>
					<tr>
						<td colspan="7">
							<div id="<%=divId %>"></div>
...
<script type="text/javascript">
	function showEditFieldsOfThisCaseReview(caseReviewId){
		var divId = "caseReviewEditDiv"+caseReviewId;
		$('#'+divId).load('showeditfieldsofthiscasereview.jsp?caseReviewId='+caseReviewId);		
	}
</script>