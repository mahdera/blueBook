...
<%
	...
	String radEffortControlName = "radeffort" + id;
	String radResponseControlName = "radresponse" + id;
	String radApplicantResponseControlName = "radapplicantresponse" + id;
	String radInputFromEvidenceControlName = "radinputfromevidence" + id;
	String radInputFromWitnessControlName = "radwitnessinput" + id;
	String radDecisionControlName = "raddecision" + id;
	String whatToRegisterContentControlName = "textarearegisteredcontent" + id;
	String fileStatusControlName = "slctfilestatus" + id;
	String nextActionAndDateControlName = "textareanextactionanddate" + id;
	String buttonId = "btnupdate" + id;
	String formId = "frminvestigation" + id;
	String radWhatToRegisterControlName = "radwhattoregister" + id;
%>
<form name="<%=formId %>" id="<%=formId %>">
			...
			<table border="0" width="100%">
						...
						<table border="0" width="100%">
							<tr>
									<td>
										...
										%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radeffort" class="radwhattoregister" value="<%					
										label = Label.getLabelUsingLabelId("lbleffort");
						 				out.print(lblEffort != null ? lblEffort : label.getLabelCaption());%>" checked="checked"/>
						 				<%
														}else{
										%>
											<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radeffort" class="radwhattoregister" value="<%
								...
								<td>
									...
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radresponse" class="radwhattoregister" value="<%										
										label = Label.getLabelUsingLabelId("lblresponse");
						 				out.print(lblResponse != null ? lblResponse : label.getLabelCaption());%>" checked="checked"/>
						 			<%
										}else{
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radresponse" class="radwhattoregister" value="<%										
								...
								<td>
									...
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radapplicantresponse" class="radwhattoregister" value="<%										
										label = Label.getLabelUsingLabelId("lblapplicantresponse");
						 				out.print(lblApplicantResponse != null ? lblApplicantResponse : label.getLabelCaption());	%>" checked="checked"/>
						 			<%
										}else{
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radapplicantresponse" class="radwhattoregister" value="<%										
								...
								<td>
									...
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radinputfromevidence" class="radwhattoregister" value="<%									
										label = Label.getLabelUsingLabelId("lblinputfromevidence");
						 				out.print(lblInputFromEvidence != null ? lblInputFromEvidence : label.getLabelCaption());%>" checked="checked"/>
					 				<%
									}else{
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radinputfromevidence" class="radwhattoregister" value="<%									
								...
								<td>
									...
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radwitnessinput" class="radwhattoregister" value="<%									
										label = Label.getLabelUsingLabelId("lblwitnessinput");
						 				out.print(lblWitnessInput != null ? lblWitnessInput : label.getLabelCaption());%>" checked="checked"/>
					 				<%
									}else{
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="radwitnessinput" class="radwhattoregister" value="<%									
								...
								<td>
									...
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="raddecision" class="radwhattoregister" value="<%
										label = Label.getLabelUsingLabelId("lbldecision");
						 				out.print(lblDecision != null ? lblDecision : label.getLabelCaption());%>" checked="checked"/>
					 				<%
									}else{
									%>
										<input type="radio" name="<%=radWhatToRegisterControlName %>" id="raddecision" class="radwhattoregister" value="<%
							...
							<%
								...
								if(!whatToRegisterContentList.isEmpty()){
									...
									while(whatToRegisterItr.hasNext()){
										...
										<tr>											
											<td>
												<textarea name="<%=whatToRegisterContentControlName %>" id="<%=whatToRegisterContentControlName %>" class="jqte-test"><%=whatToRegisterContentObj.getRegisteredContent() %></textarea>
											</td>
										</tr>
										<%
									}//end while loop
				...
				<tr style="background:#eee">
	 			...
	 			%></label></strong></td>
					<td>
						<textarea class="jqte-test" id="<%=nextActionAndDateControlName %>" name="<%=nextActionAndDateControlName %>" style="width:100%"><%=investigation.getNextActionAndDate() %></textarea>
					</td>
				</tr>				
				<tr style="background:#eee">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#'+buttonId).click(function(){
			var radEffortControlName = "radeffort" + id;
			var radResponseControlName = "radresponse" + id;
			var radApplicantResponseControlName = "radapplicantresponse" + id;
			var radInputFromEvidenceControlName = "radinputfromevidence" + id;
			var radInputFromWitnessControlName = "radwitnessinput" + id;
			var radDecisionControlName = "raddecision" + id;
			var whatToRegisterContentControlName = "textarearegisteredcontent" + id;
			var fileStatusControlName = "slctfilestatus" + id;
			var nextActionAndDateControlName = "textareanextactionanddate" + id;			
			//now get the values of the controls define just above...
			var radioButtonName = "radwhattoregister" + id;
			var formId = "frminvestigation" + id;
			var whatToRegister = $('input[name=' + radioButtonName + ']:checked', '#' + formId).val();
			var whatToRegisterContent = $('#'+whatToRegisterContentControlName).val();
			var fileStatusId = $('#'+fileStatusControlName).val();
			var nextActionAndDate = $('#'+nextActionAndDateControlName).val();
			var fileNumber = "<%=fileNumber%>";
			
			if(id != "" && whatToRegister != "" && whatToRegisterContent != "" && fileStatusId != "" &&
					nextActionAndDate != "" && fileNumber != ""){
				var dataString = "id="+id+"&whatToRegister="+whatToRegister+"&whatToRegisterContent="+
				whatToRegisterContent+"&fileStatusId="+fileStatusId+"&nextActionAndDate="+nextActionAndDate;
				
				$.ajax({
				    url: 'updateinvestigation.jsp',		
				    data: dataString,
				    type:'POST',
