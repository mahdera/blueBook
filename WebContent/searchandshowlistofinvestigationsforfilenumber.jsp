				...
				<%
					...
					while(investigationItr.hasNext()){
						...
						<tr>
							...
							<td>
								<a href="#.jsp" onclick="showDetailsOfThisInvestigation(<%=investigation.getId() %>);">
									<label id="lblviewdetail">
										<%											
											label = Label.getLabelUsingLabelId("lblviewdetail");
											out.print(lblViewDetail != null ? lblViewDetail : label.getLabelCaption());				
										%>
...
<script type="text/javascript">
	function showDetailsOfThisInvestigation(id){
		var divId = "investigationDiv" + id;
		$('#'+divId).load('showdetailsofthisinvestigation.jsp?id='+id);
	}
