	...
	<div id="main">
		...
		<div id="cols" class="box">
			...
			<div id="aside" class="box">
				<%@include file="indexleftpaddingboxinvestigation.jsp"%>
			</div>
			<!-- /aside -->
			...
			<div id="content" class="box">
				...
				<table border="1" width="100%">
					<tr style="background:white">
						...
						የሕዝብ ዕንባ ጠባቂ ተቋም የአቤቱታ ጉዳዮች መከታተያ ሶፍትዌር የምርመራ ገፅ<br/>Inistitution of The Ombudsman Case Investigation Page.
						<br/>
						</font>
						</strong></td>
					</tr>					
				...
				<div style="height:800px">					
					<img src="images/inv_main.png" width="100%" alt="No pic"/>
				</div>				
