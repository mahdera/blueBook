...
<div>	
	<!-- Tabs -->
			...
			<div class="tabs box"> 
				<ul> 
					<li><a href="#.jsp" id="newRegistrationLink"><span>New Registration</span></a></li>					 
					<li><a href="#.jsp" onclick="showCaseManagementInInnerDiv();"><span>View Registration</span></a></li>					 
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#newRegistrationLink').click(function(){
			$('#intakeProcessDetailDiv').load('shownewregistrationform.jsp');
		});		
