...
<form>
	<table border="0" width="100%">
		<tr>
			...
			<td>
				<input type="button" value="Show/አሳይ" class="input-submit" id="btnshow" onclick="showAllCaseReviewsForThisApplicantForDelete(
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnshow').click(function(){
			...
			if(applicantId != ""){
				$('#caseReviewListDiv').load('showallcasereviewsforthisapplicantfordelete.jsp?applicantId='+applicatnId);
			}
		});
