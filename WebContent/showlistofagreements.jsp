		...
		<table border="0" width="100%">
			<tr style="background:#eee;font-weight:bolder;">
				...
				<td><label id="lblagreementdate"><%
		 			...
		 			%></label></td>
				<td><label id="lblviewdetail"><%
						String lblViewDetail = LanguageTranslation.getLabelCaptionInTheSelectedLanguage(langId,"lblviewdetail");
						label = Label.getLabelUsingLabelId("lblviewdetail");
		 				out.print(lblViewDetail != null ? lblViewDetail : label.getLabelCaption());
		 			%></label></td>				
			</tr>
			<%
				int ctr=1;
				while(agreementItr.hasNext()){
					...
					%>
						<tr>
							...
							<td>
								<a href="#.jsp" onclick="showDetailsOfThisAgreement(<%=agreement.getId() %>);"><label id="lblviewdetail"><%
						lblViewDetail = LanguageTranslation.getLabelCaptionInTheSelectedLanguage(langId,"lblviewdetail");
						label = Label.getLabelUsingLabelId("lblviewdetail");
		 				out.print(lblViewDetail != null ? lblViewDetail : label.getLabelCaption());
		 			%></label></a>
								|
								<a href="#.jsp" onclick="hideDetailsOfThisAgreement(<%=agreement.getId() %>);"><label id="lblhide"><%
...
<script type="text/javascript">
	function showDetailsOfThisAgreement(agreementId){
		var divId = "agreementDetailDiv" + agreementId;
		$('#'+divId).load('showdetailsofthisagreement.jsp?agreementId='+agreementId);
	}
