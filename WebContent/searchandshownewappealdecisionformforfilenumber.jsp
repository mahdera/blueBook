		...
		<form name="frmnewappeal" id="frmnewappeal">
			...
			<table border="0" width="100%">
						...
						<%
							...
							if(!appealList.isEmpty()){
								...
								while(appealItr.hasNext()){
									...
									<p>
										<%
											out.print(appeal.getAppealReason());
										%>
									</p>
									<%
								}//end while loop
				...
				<tr>
					...
					<td>
							<select name="slctappealdecision" id="slctappealdecision" style="width:100%">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnsave').click(function(){
			...
			var appealDecision = $('#slctappealdecision').val().trim();			
						
			if(fileNumber != "" && appealDecision != ""){
				var dataString = "fileNumber="+fileNumber+"&appealDecision="+appealDecision;
				
				var divId = "newAppealDiv";
				//now save this information to the database...
				$.ajax({
				    url: 'saveappealdecision.jsp',		
				    data: dataString,
				    type:'POST',
