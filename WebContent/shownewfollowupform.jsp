		...
		<td>
			...
			<select name="txtfilenumber" id="txtfilenumber" style="width:40%">
				...
				<%
					...
					List<String> fileNumberList = Utility.filterFileNumberFoundInForUser("tbl_investigator_assignment", "tbl_followup", "investigator_id", investigator.getId());
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnsearch').click(function(){			
			...
			if(fileNumber != ""){
				$('#newFollowupDiv').load('searchandshownewfollowupformforfilenumber.jsp?fileNumber='+fileNumber);
			}
		});
