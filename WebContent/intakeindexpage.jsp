	...
	<div id="main">
		...
		<div id="cols" class="box">
			...
			<div id="aside" class="box">
				<%@include file="indexleftpaddingboxintake.jsp"%>
			</div>
			<!-- /aside -->
			...
			<div id="content" class="box">
				...
				<table border="1" width="100%">
					<tr style="background:white">
						...
						የሕዝብ ዕንባ ጠባቂ ተቋም የአቤቱታ ጉዳዮች መከታተያ ሶፍትዌር የቅበላ ገፅ<br/>Inistitution of The Ombudsman Case Intake Page.
						<br/>
						</font>
						</strong></td>
					</tr>					
				...
				<div style="height:680px">					
					<img src="images/intakehome.png" width="100%"/>
				</div>				
