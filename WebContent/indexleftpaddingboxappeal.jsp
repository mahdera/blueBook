...
<div class="padding box">
	...
	<p class="box">		 
		<form name="frmlogin" id="frmlogin" method="post" action="validateappealofficer.jsp" onsubmit="return isLoginFormBlank(document.getElementById('txtusername').value,
